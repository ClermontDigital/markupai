...
class StyleChecks
{
    ...
    {
        // Style checks API requires file upload - use createWithFile() instead
        throw new \BadMethodCallException('Style checks require file upload. Use createWithFile() method instead.');
    }
